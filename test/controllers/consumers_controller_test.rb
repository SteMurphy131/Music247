...
class ConsumersControllerTest < ActionController::TestCase
  ...
  test "should create consumer" do
    assert_difference('Consumer.count') do
      post :create, consumer: { email: @consumer.email, name: @consumer.name, password_digest: @consumer.password_digest }
    end
  ...
  test "should update consumer" do
    patch :update, id: @consumer, consumer: { email: @consumer.email, name: @consumer.name, password_digest: @consumer.password_digest }
    assert_redirected_to consumer_path(assigns(:consumer))
  end
