...
class LabelsControllerTest < ActionController::TestCase
  ...
  test "should create label" do
    assert_difference('Label.count') do
      post :create, label: { image: @label.image, location: @label.location, name: @label.name, owner: @label.owner }
    end
  ...
  test "should update label" do
    patch :update, id: @label, label: { image: @label.image, location: @label.location, name: @label.name, owner: @label.owner }
    assert_redirected_to label_path(assigns(:label))
  end
